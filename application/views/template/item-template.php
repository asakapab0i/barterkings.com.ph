<?php foreach ($data as $value): ?>
	...
	<div class="page-tags" style="border-top: 1px solid #e7e7e7; padding-top: 10px;">
		<small>Category:</small> <a class="label label-primary" style="background-color: <?php echo_if_not_empty($value['category_color']); ?>" href="<?php linkify_to_category($value['category_class']); ?>"> <?php echo_if_not_empty($value['category_name']); ?></a>
	</div>
